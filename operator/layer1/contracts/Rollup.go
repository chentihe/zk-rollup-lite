...
func DeployRollup(auth *bind.TransactOpts, backend bind.ContractBackend, _txVerifier common.Address, _withdrawVerifier common.Address) (common.Address, *types.Transaction, *Rollup, error) {
	...
	address, tx, contract, err := bind.DeployContract(auth, *parsed, common.FromHex(RollupBin), backend, _txVerifier, _withdrawVerifier)
	if err != nil {
		return common.Address{}, nil, nil, err
	}
...
//
// Solidity: function deposit(uint256 publicKeyX, uint256 publicKeyY) payable returns()
func (_Rollup *RollupTransactor) Deposit(opts *bind.TransactOpts, publicKeyX *big.Int, publicKeyY *big.Int) (*types.Transaction, error) {
	return _Rollup.contract.Transact(opts, "deposit", publicKeyX, publicKeyY)
}

// Deposit is a paid mutator transaction binding the contract method 0xe2bbb158.
//
// Solidity: function deposit(uint256 publicKeyX, uint256 publicKeyY) payable returns()
func (_Rollup *RollupSession) Deposit(publicKeyX *big.Int, publicKeyY *big.Int) (*types.Transaction, error) {
	return _Rollup.Contract.Deposit(&_Rollup.TransactOpts, publicKeyX, publicKeyY)
}

// Deposit is a paid mutator transaction binding the contract method 0xe2bbb158.
//
// Solidity: function deposit(uint256 publicKeyX, uint256 publicKeyY) payable returns()
func (_Rollup *RollupTransactorSession) Deposit(publicKeyX *big.Int, publicKeyY *big.Int) (*types.Transaction, error) {
	return _Rollup.Contract.Deposit(&_Rollup.TransactOpts, publicKeyX, publicKeyY)
}
...
// Withdraw is a paid mutator transaction binding the contract method 0x5f2ee1bd.
//
// Solidity: function withdraw(uint256 amount, uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[3] input) returns()
func (_Rollup *RollupTransactor) Withdraw(opts *bind.TransactOpts, amount *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [3]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function withdraw(uint256 amount, uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[3] input) returns()
func (_Rollup *RollupSession) Withdraw(amount *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [3]*big.Int) (*types.Transaction, error) {
...
//
// Solidity: function withdraw(uint256 amount, uint256[2] a, uint256[2][2] b, uint256[2] c, uint256[3] input) returns()
func (_Rollup *RollupTransactorSession) Withdraw(amount *big.Int, a [2]*big.Int, b [2][2]*big.Int, c [2]*big.Int, input [3]*big.Int) (*types.Transaction, error) {
	return _Rollup.Contract.Withdraw(&_Rollup.TransactOpts, amount, a, b, c, input)
}
